      ...
      <div className="relative bg-white">
        <div className="max-w-7xl mx-auto">
          <div
            className={`${
              open ? "z-0" : "z-10"
            } relative flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-1`}
          >
            <div className="flex justify-start lg:w-0 lg:flex-1">
              <Link to="/">
                <span className="sr-only">Stories App</span>
        ...
        <div
          className={
            open
              ...
              : "z-0 opacity-0 scale-95 absolute top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden"
          }
        >
